...
var pages = {
  ...
  start: {
    text:"You found some suspicious marks in the sheepfold. The suspicious traces will be:",
  ...
  wolf: {
    text:
      "You find the wolf footprints and follow them arrive at:",
    leftLabel: "lake",
    rightLabel: "A deep tree hole",
    leftPage: "lake",
    rightPage: "treehole",
    img:"https://i.ibb.co/smM4j0S/58081910-wolf-dog-footprint-paw-tracks-in-mud.jpg"
  },
  treehole: {
    text:
  ...
  death: {
    text:
      "Suddenly you wake up from bed, it turns out to be a dream. You will",
  ...
  world: {
    text:
      "You have find a new world, this world is full of:",
...
class App extends Component {
  ...
  render() {
    ...
    if(pageData.leftLabel){
      leftLabel= (
        <button id="leftButton" onClick={() => this.goToPage(pageData.leftPage)}>
          {pageData.leftLabel}
        </button>
      );
    }
    ...
    if(pageData.middleLabel){
      middleLabel= (
        <button id="middleButton" onClick={() => this.goToPage(pageData.middlePage)}>
    ...
    if(pageData.rightLabel){
      rightLabel= (
        <button id="rightButton" onClick={() => this.goToPage(pageData.rightPage)}>
          {pageData.rightLabel}
        </button>
      );
    }
    ...
    return (
      ...
      <div className="My-own-Adventure">
